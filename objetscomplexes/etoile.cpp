...
Etoile::Etoile(std::mt19937 &rg)
    : Astre{{util::alea(0, 1366, rg), util::alea(0, 400, rg)}},
      m_triangle1{{m_coords.getX(), m_coords.getY() - (10)}, {m_coords.getX() + (5), m_coords.getY()},
          {m_coords.getX() - (5), m_coords.getY()}, {255, 250, 205}},
      m_triangle2{{m_coords.getX() + (10), m_coords.getY()}, {m_coords.getX(), m_coords.getY() - (5)},
          {m_coords.getX(), m_coords.getY() + (5)}, {255, 250, 205}},
      m_triangle3{{m_coords.getX(), m_coords.getY() + (10)}, m_triangle1.getSommets()[1], m_triangle1.getSommets()[2],
          {255, 250, 205}},
      m_triangle4{{m_coords.getX() - (10), m_coords.getY()}, m_triangle2.getSommets()[1], m_triangle2.getSommets()[2],
          {255, 250, 205}} {}
...
///Apres avoir dessiner l'Etoile dans le svg.file on rajoute des effets de brillance
    ...
    svgout.addDisk(m_coords.getX(),
                   m_coords.getY(),
                   2.5 * (m_triangle1.getSommets()[1].getX() - m_coords.getX()),
                   makeRGB(255, 250, 205),
                   0.2);
}

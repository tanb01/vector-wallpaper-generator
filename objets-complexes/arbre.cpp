...
Arbre::Arbre(std::mt19937 &rg)
    : Plantes{{util::alea(0, 1366, rg), util::alea(650, 750, rg)}},
      m_tronc{{m_coords.getX(), m_coords.getY() - 160},
          {m_coords.getX() + util::alea(5, 10, rg), m_coords.getY() + util::alea(5, 10, rg)},
          {m_coords.getX() - util::alea(5, 10, rg), m_coords.getY() + util::alea(5, 10, rg)}, {160, 82, 45}},
      m_otronc{m_tronc.getSommets()[0], m_tronc.getSommets()[1],
          {m_coords.getX(), m_coords.getY() + util::alea(5, 10, rg)}, {160, 82, 45}},
      m_feuilles{{m_coords.getX(), m_coords.getY() - 160}, util::alea(40, 74, rg),
          {util::alea(0, 54, rg), util::alea(100, 170, rg), util::alea(0, 54, rg)}},
      m_ofeuilles{{m_feuilles.getCoords().getX() + 10, m_feuilles.getCoords().getY()}, m_feuilles.getRayon() * 0.9,
          {0, 0, 0}} {}
...
void Arbre::dessiner(Svgfile &svgout) {
    ...
    svgout.addDisk(m_ofeuilles.getCoords().getX(),
                   m_ofeuilles.getCoords().getY(),
                   m_ofeuilles.getRayon(),
                   makeRGB(0, 0, 0),
                   0.5);
